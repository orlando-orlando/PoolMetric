...
/* =====================================================
   ICONOS SVG — representación fiel de cada cuerpo de agua
   Estilo: vista superior de planta, trazo limpio
===================================================== */

/* Alberca: planta rectangular con carriles, escaleras esquineras y skimmer */
const IconoAlberca = () => (
...
/* Jacuzzi: planta octagonal con boquillas de hidromasaje y burbujas interiores */
const IconoJacuzzi = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
    <polygon
      points="17,8 31,8 40,17 40,31 31,40 17,40 8,31 8,17"
    ...
    <polygon
      points="19,13 29,13 36,20 36,28 29,35 19,35 12,28 12,20"
      stroke="#7dd3fc" strokeWidth="0.7" fill="none" strokeDasharray="2 2" opacity="0.4"
    />
  </svg>
);

/* Chapoteadero: planta orgánica/ovalada baja con sol decorativo */
...
/* Espejo de agua: lámina ultra delgada con efecto reflejo y cortinas laterales */
...
/* Alberca + Jacuzzi: planta alberca rectangular + jacuzzi octagonal anexo */
const IconoAlbercaJacuzzi = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
    ...
    <polygon points="36,10 43,10 47,14 47,22 43,26 36,26 32,22 32,14"
      stroke="#7dd3fc" strokeWidth="1.5" fill="rgba(125,211,252,0.08)"/>
...
/* Alberca + Chapoteadero: planta alberca rectangular + chapoteadero ovalado */
...
/* Alberca + Jacuzzi + Jacuzzi: alberca grande + dos octagonales separados */
const IconoAlbercaJacuzziJacuzzi = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
    ...
    <polygon points="33,8 40,8 44,12 44,19 40,23 33,23 29,19 29,12"
      stroke="#7dd3fc" strokeWidth="1.3" fill="rgba(125,211,252,0.08)"/>
    ...
    <polygon points="33,27 40,27 44,31 44,38 40,42 33,42 29,38 29,31"
      stroke="#a78bfa" strokeWidth="1.3" fill="rgba(167,139,250,0.08)"/>
...
/* Alberca + Chapoteadero + Asoleadero */
...
const IconoAlbercaJacuzziChapo = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
    ...
    <path d="M7 19 Q11 17 15 19 Q19 21 22 19" stroke="#38bdf8" strokeWidth="0.8" fill="none" strokeLinecap="round" opacity="0.45"/>
    <rect x="3" y="30" width="3" height="6" rx="1" stroke="#7dd3fc" strokeWidth="0.8" fill="rgba(125,211,252,0.1)"/>
    <polygon points="32,8 39,8 43,12 43,20 39,24 32,24 28,20 28,12"
      stroke="#7dd3fc" strokeWidth="1.3" fill="rgba(125,211,252,0.08)"/>
...
const Dimensiones = forwardRef(({ setSeccion, sistemaActivo, setSistemaActivo, datosPorSistema, setDatosPorSistema }, ref) => {
          ...
          return (
            <div key={i} className="selector-grupo">
              ...
              <div className="selector-grid">
                <div className="campo">
                  <label>Área (m²)</label>
                  <input type="number" value={cuerpo.area}
                    onChange={(e) => { const cuerpos = [...datos.cuerpos]; cuerpos[i] = { ...cuerpos[i], area: e.target.value }; actualizarDatos({ cuerpos }); }}
                ...
                <div className="campo">
                  ...
                  <input type="number" value={cuerpo.profMin}
                    onChange={(e) => { const cuerpos = [...datos.cuerpos]; cuerpos[i] = { ...cuerpos[i], profMin: e.target.value }; actualizarDatos({ cuerpos }); }}
                ...
                <div className="campo">
                  ...
                  <input type="number" value={cuerpo.profMax}
                    onChange={(e) => { const cuerpos = [...datos.cuerpos]; cuerpos[i] = { ...cuerpos[i], profMax: e.target.value }; actualizarDatos({ cuerpos }); }}
        ...
        <div className="selector-grupo">
          ...
          <div className="selector-grid">
            <div className="campo">
              ...
              <input type="number" value={datos.distCuarto}
          ...
          <div className="selector-grupo">
            ...
            {(datos.desborde === "infinity" || datos.desborde === "ambos") && (<>
              <div className="selector-grid">
                <div className="campo">
                  ...
                  <input type="number" value={datos.largoInfinity}
                ...
                <div className="campo">
                  ...
                  <input type="number" value={datos.profCortina}
              ...
              <div className="selector-grupo">
                ...
                <div className={`selector-radios ${mostrarErrores && errores.usarBombaInfinity ? "input-error" : ""}`}
                  onMouseEnter={() => setHoveredField("usarBombaInfinity")} onMouseLeave={() => setHoveredField(null)}>
                  <label>
                    <input type="radio" checked={datos.usarBombaInfinity === "si"} onChange={() => actualizarDatos({ usarBombaInfinity: "si" })} />
                    Sí, bomba independiente
                  </label>
                  <label>
                    <input type="radio" checked={datos.usarBombaInfinity === "no"} onChange={() => actualizarDatos({ usarBombaInfinity: "no" })} />
                    No, comparte bomba
                  </label>
                </div>
              </div>
            ...
            {(datos.desborde === "canal" || datos.desborde === "ambos") && (
              <div className="campo">
                ...
                <input type="number" value={datos.largoCanal}
  ...
  const renderCardSistema = (key) => {
    ...
    return (
      <div
        key={key}
        className={`sistema-cal-card ${activo ? "activo" : ""}`}
        onClick={() => {
      ...
      >
        <div className="sistema-cal-icon">{icono}</div>
        <div className="sistema-cal-label">{s.nombre}</div>
            ...
            GRUPOS_SISTEMAS.map(({ label, keys }) => (
              <div key={label} className="lista-sistemas-grupo">
                ...
                <div className="sistemas-calentamiento-grid" style={{
                  gridTemplateColumns: keys.length <= 2
                    ? `repeat(${keys.length}, 1fr)`
                    : "repeat(4, 1fr)",
                }}>
