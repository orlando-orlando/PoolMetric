...
// ─────────── COLOMBIA ───────────
  "bogota": {
    min: [7, 7.5, 8.5, 9.5, 9.5, 9, 8.8, 8, 8, 8.5, 8.8, 7.5],
    max: [19, 19, 19, 18.3, 18, 17.5, 17, 17.8, 18, 18, 18, 18.5]
  },
  "medellin": {
    min: [17, 17, 17, 17.8, 17.8, 17, 16.8, 16.8, 17, 17, 17, 17],
    max: [25, 25, 25, 25.8, 26, 26, 26, 25.8, 25, 25, 25, 25]
  },
  "barranquilla": {
    min: [24.7, 25, 25, 25.5, 26, 26, 25.8, 25, 25, 25, 25, 25],
    max: [30, 30, 31.5, 31.5, 32, 32, 31.8, 32, 31.8, 31, 31, 30.5]
  },
  "cartagena": {
    min: [24, 24.8, 25, 25.8, 26, 26, 26, 26, 26, 26, 25.8, 24.8],
    max: [30, 30, 30.8, 31, 31, 31, 31, 31, 31, 31, 31, 30.8]
  },
  "santaMarta": {
    min: [24, 24.8, 25.8, 26, 27, 26.8, 26, 26, 26, 26, 25.8, 24.5],
    max: [31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31]
  },
  "bucaramanga": {
    min: [20, 20.8, 21, 21, 21, 21, 21, 21, 21, 21, 21, 20.5],
    max: [27, 27, 27, 27, 27, 27, 27, 27, 27, 26.5, 26, 26.8]
  },
  "pereira": {
    min: [17, 18, 18, 18, 17.8, 17, 17, 17, 17, 17, 17, 17],
    max: [26, 26, 26, 25, 25, 25, 25.8, 26, 25.8, 25, 25, 25.8]
  },
  "monteria": {
    min: [23.8, 24, 24, 24.8, 25, 25, 25, 25, 24, 24, 24, 24],
    max: [33.8, 34.8, 35, 34, 32.5, 32, 32, 31.8, 31, 31, 31.7, 32.2]
  },
  "sincelejo": {
    min: [22, 22, 22.8, 23.8, 23.8, 23, 23, 23, 23, 22.6, 22, 22],
    max: [33.8, 34, 34, 33.5, 32.8, 32, 32, 32, 31.8, 31, 31.7, 32.2]
  },
  "armenia": {
    min: [15, 15, 16, 17, 17, 17, 17, 17, 17, 16, 15, 15],
    max: [25.8, 26, 25.8, 25, 25, 25, 25.5, 26, 25.7, 25, 25, 25]
  },
  "tunja": {
    min: [5, 6, 7, 7.8, 8, 7.5, 7, 7, 6.7, 7, 7, 6],
    max: [17, 17, 17, 17, 16.8, 15.8, 15, 15, 15.7, 16.8, 17, 17]
  },
  "pasto": {
    min: [9, 9, 9, 8.8, 8, 7.8, 7, 7, 7.3, 8, 8.3, 9],
    max: [16, 16, 16, 16, 16, 15.5, 15.8, 16.5, 17, 16.8, 16, 16]
  },
  "quibdo": {
    min: [25, 25, 24.8, 25, 25, 25, 25, 25, 24.7, 24, 24, 24.5],
    max: [31, 31, 31, 30.5, 30, 30.5, 31, 31, 30.3, 30, 30, 30.5]
  },
  "villavicencio": {
    min: [20, 20.7, 21.5, 22, 22, 22, 21, 21, 21, 21.5, 21.7, 20.5],
    max: [31.5, 32, 31.5, 30.8, 29.8, 29, 28.2, 28.8, 29.3, 30, 30.7, 31]
  },
  "neiva": {
    min: [23, 23, 23, 23, 23, 23, 23.2, 24, 23.5, 23, 23, 23],
    max: [32, 32, 32, 31, 31.2, 32, 32.2, 33, 33, 31.8, 31, 31.2]
  },
  "cucuta": {
    min: [22, 22.3, 23, 23.8, 24.2, 25, 25, 25, 24.3, 23.8, 23, 22.5],
    max: [30, 30, 30.5, 31, 31.8, 31.8, 31.8, 32.5, 32.8, 31.8, 30.7, 30]
  },
  "cali": {
    min: [19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19],
    max: [28.8, 29, 29, 28.2, 28, 28.5, 29, 29, 29, 29, 28.2, 28]
  }
};
...
// ─────────── COLOMBIA ───────────
  "bogota": { max: [5.8, 6.1, 5.6, 5.1, 5.7, 6.8, 7.8, 7.5, 6.3, 4.8, 4.3, 5] },
  "medellin": { max: [2.8, 2.9, 2.8, 2.7, 2.6, 2.9, 3.1, 3, 2.7, 2.5, 2.4, 2.6] },
  "barranquilla": { max: [22.8, 24, 23.5, 20.3, 15.6, 14.2, 15.4, 13.9, 11.9, 11.8, 15.4, 19.8] },
  "cartagena": { max: [20.8, 22.6, 22.1, 18.9, 13.9, 11.9, 12.5, 11.9, 10.8, 11.2, 13.7, 17.5] },
  "santaMarta": { max: [26.2, 27.1, 26.1, 23, 19, 18.7, 20.1, 17.9, 15.2, 14.8, 18.7, 23.4] },
  "bucaramanga": { max: [5.9, 6.1, 5.7, 5.2, 4.7, 4.6, 4.7, 4.6, 4.7, 4.8, 5, 5.4] },
  "pereira": { max: [3.3, 3.3, 3.3, 3.4, 3.7, 4.2, 4.7, 4.6, 4.1, 3.6, 3.4, 3.2] },
  "monteria": { max: [5.9, 6.6, 6.8, 6.4, 4.9, 4, 3.8, 4, 4.1, 4.4, 4.4, 5] },
  "sincelejo": { max: [6.1, 6.9, 7, 6.6, 5.2, 4.4, 4.4, 4.4, 4.4, 4.7, 4.7, 5.4] },
  "armenia": { max: [4.2, 4.2, 4.4, 4.9, 5.4, 6.3, 6.6, 6.6, 5.8, 4.9, 4.3, 4.2] },
  "tunja": { max: [6.3, 6.6, 6.6, 6.5, 7.4, 8.7, 8.8, 8.8, 8, 6.6, 4.9, 5.5] },
  "pasto": { max: [5.3, 5.6, 5.6, 6.2, 7.7, 10, 10.9, 10.9, 9.2, 6.4, 5, 5.3] },
  "quibdo": { max: [3.3, 3.2, 3.2, 3.2, 3.1, 3.1, 3.1, 3.3, 3.5, 3.6, 3.6, 3.6] },
  "villavicencio": { max: [6.7, 6.7, 6.4, 5.7, 5.2, 5.6, 5.6, 5.6, 5.4, 5.1, 4.9, 6] },
  "neiva": { max: [7.7, 7.9, 7.9, 8.2, 8.4, 9.4, 10.2, 10.3, 10, 8.7, 6.8, 7] },
  "cucuta": { max: [8.5, 8.5, 8.5, 8.9, 10.2, 11.8, 11.9, 11.6, 10.1, 8.6, 7.5, 8.3] },
  "cali": { max: [6.1, 5.4, 4.9, 4.6, 4.4, 4.6, 4.9, 4.8, 4.7, 6.2, 6.4, 6.2] }
};
...
// ─────────── COLOMBIA ───────────
  "bogota": { promedio: [67, 69, 74, 72, 77, 78, 81, 75, 77, 75, 72, 78] },
  "medellin": { promedio: [82, 70, 72, 76, 75, 75, 50, 69, 80, 80, 77, 80] },
  "barranquilla": { promedio: [80, 74, 73, 80, 80, 79, 80, 80, 81, 81, 79, 80] },
  "cartagena": { promedio: [80, 75, 74, 80, 81, 81, 81, 81, 82, 83, 80, 80] },
  "santaMarta": { promedio: [75, 74, 73, 77, 80, 78, 77, 80, 77, 80, 78, 80] },
  "bucaramanga": { promedio: [79, 81, 77, 80, 80, 87, 75, 75, 80, 80, 77, 78] },
  "pereira": { promedio: [80, 73, 74, 77, 76, 77, 70, 66, 75, 77, 82, 77] },
  "monteria": { promedio: [73, 74, 77, 75, 80, 79, 78, 82, 87, 83, 83, 79] },
  "sincelejo": { promedio: [68, 74, 70, 71, 80, 75, 75, 78, 80, 81, 81, 75] },
  "armenia": { promedio: [81, 82, 78, 75, 80, 77, 80, 87, 83, 83, 82, 77] },
  "tunja": { promedio: [77, 79, 78, 80, 78, 79, 82, 79, 81, 79, 78, 80] },
  "pasto": { promedio: [80, 80, 79, 89, 80, 75, 88, 75, 83, 81, 82, 82] },
  "quibdo": { promedio: [90, 85, 86, 90, 89, 89, 87, 92, 88, 89, 92, 88] },
  "villavicencio": { promedio: [69, 76, 91, 97, 97, 83, 87, 95, 92, 94, 80, 76] },
  "neiva": { promedio: [86, 69, 71, 82, 71, 86, 58, 55, 56, 70, 80, 82] },
  "cucuta": { promedio: [70, 67, 75, 75, 74, 68, 70, 70, 70, 75, 74, 76] },
  "cali": { promedio: [71, 72, 74, 76, 75, 76, 74, 75, 74, 79, 75, 72] }
};
